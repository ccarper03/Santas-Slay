...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'BuildTezt.data';
    var REMOTE_PACKAGE_BASE = 'BuildTezt.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3458598;
      var PACKAGE_UUID = '7d7e232b-dc9d-4a8f-ad65-091d9b7029bd';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 140136, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(140136, 140157, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(140157, 142933, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(142933, 1949545, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1949545, 3430973, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3430973, 3458598, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_BuildTezt.data');

    };
    Module['addRunDependency']('datafile_BuildTezt.data');
